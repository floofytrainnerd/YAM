package floofytrainnerd.yam.worldgen;
...
public class WorldGenTreesNonto extends WorldGenAbstractTree
{
    private IBlockState blockStateWood = ModBlocks.blockLogNonto.getDefaultState();
    private IBlockState blockStateLeaves = ModBlocks.blockLeavesNonto.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
     ...
     */
    public WorldGenTreesNonto(boolean parShouldNotify)
    {
